...
const AddParcel = () => {
  ...
  const handleParcel = (data) => {
    ...
    console.log(checkRegion, isDocument, productWeight);
    let cost = 0;
    if (isDocument === "true") {
    ...
    Swal.fire({
      title: "Are you sure?",
      text: `Your delivery charge ${cost}!`,
      icon: "warning",
      ...
      if (result.isConfirmed) {
        Swal.fire({
          title: "Done!",
          text: "Your delivery process success.",
          icon: "success",
        });
      }
    });
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex flex-col mt-3 flex-1 w-full">
                ...
                <select
                  ...
                  className="select my_input bg-transparent focus-within:bg-gray-100 text-[#94A3B8] focus-within:text-black "
            ...
            <div className="flex flex-col mt-3 flex-1">
              ...
              <select
                id="receiverDelivery"
                defaultValue="Select Wire House"
                className="select my_input bg-transparent focus-within:bg-gray-100 shuvomallik999@gmail.comtext-[#94A3B8] w-full focus-within:text-black"
                placeholder="Select Wire house"
